...
class SettingsWindow(tk.Toplevel):
    def __init__(self, master, state, save_config):
        ...
        style = ttk.Style()
        style.configure("Modern.TNotebook", background=THEME["bg"], borderwidth=0)
        style.configure(
        ...
        ModernButton(
            btn_frame, text="✗ Close", command=self.destroy, style="danger"
    ...
    def create_timeline_tab(self):
        ...
        scrollbar = tk.Scrollbar(
            frame, orient="vertical", command=canvas.yview, bg=THEME["bg_secondary"]
        )
    ...
    def create_throw_tab(self):
        ...
        self.e_throw_start_settle = add_entry(
            "Start Settle Delay (s):", "throw_start_settle_delay", 0.03
        )
        self.e_throw_pre_drag = add_entry(
            "Pre-Drag Delay (s):", "throw_pre_drag_delay", 0.06
        )
        self.e_throw_tab_delay = add_entry(
            "Tab Delay After Drag (s):", "throw_tab_delay_after_drag", 0.3
        )
        self.e_throw_final_settle = add_entry(
            "Final Settle Delay (s):", "throw_final_settle_delay", 0.05
        )
        self.e_throw_pre_spam = add_entry(
            "Pre-Spam Delay (s):", "throw_pre_spam_delay", 0.0
        )
        self.e_throw_post_tab_spam = add_entry(
            "Post-Tab to Spam Delay (s):", "throw_post_tab_to_spam_delay", 0.004
        )

        add_section("Tap Timing")
        self.e_throw_post_clumsy = add_entry(
            "Post-Clumsy Tap Delay (s):", "throw_post_clumsy_tap_delay", 0.021
        )
        self.e_throw_post_tab = add_entry(
            "Post-Tab Tap Delay (s):", "throw_post_tab_tap_delay", 0.021
        )
        self.e_throw_clumsy_deactivate = add_entry(
            "Clumsy Deactivate After Spam (s):",
        ...
        self.e_throw_spam_duration = add_entry(
            "Spam Duration (s):", "throw_spam_duration", 2.25
        )
        ...
        self.e_throw_drag_pixels = add_entry(
            "Drag Left Pixels:", "throw_drag_left_pixels", -2000
        )
    ...
    def save_settings(self):
        ...
        try:
            ...
            c["throw_clumsy_deactivate_after_spam"] = float(
                self.e_throw_clumsy_deactivate.get()
            )
